...
public class NovaPoshtaService(IMapper mapper, IHttpClientFactory httpClientFactory, AppDbContext context) : INovaPoshtaService
{
    ...
    private readonly string apiKey = "3740308be13fc7617cb6397c9f44a83d";
